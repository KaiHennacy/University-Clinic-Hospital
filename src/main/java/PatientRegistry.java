...
public class PatientRegistry {
	...
	public void printTable() {
		System.out.println("\nPATIENTS");
		System.out.printf("%-8s %-20s %-20s %-15s %-15s \n", "ID Num|", "Health Level|", "Blood Level|", "Nurse ID|", "Nurse Name|");
		for(Patient pat : patients.values()) 
			System.out.printf("%-8d %-20d %-20d %-15d %-15s \n", pat.getIdNum(), pat.getHEALTH_LEVEL(), pat.getBLOOD_LEVEL(), pat.getAssignedNurseId(), pat.getAssignedNurseName());
	}
